import { Lightbulb, MessageSquarePlus, TrendingUp, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6"
        style={{ background: "radial-gradient(ellipse at 90% 0%, rgba(37,99,235,0.10) 0%, transparent 55%), var(--color-surface)" }}
      >
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-lg font-semibold text-[var(--color-text-1)]">Comparte tu opinión</h1>
            <p className="mt-1 text-sm text-[var(--color-text-2)]">
              Tu feedback nos ayuda a mejorar la app cada día. Cuéntanos ideas, errores o cualquier cosa que creas que podría funcionar mejor.
            </p>
          </div>
        </div>
