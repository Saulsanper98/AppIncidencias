...
export const DASHBOARD_TEMPLATES: DashboardTemplate[] = [
  ...
  },
  {
    id: "turno-actual",
    name: "Turno actual",
    description: "Lo que pasa hoy: carga M/T/N, backlog, SLA urgentes y bandeja en un vistazo.",
    accentColor: "#D97706",
    icon: Sun,
    widgets: [
      {
      ...
      },
      {
        title: "SLA vencidos",
        chartType: "kpi",
        dataSource: "kpi_sla_vencidos",
        size: "small",
        config: { accentColor: "#F43F5E", ...kpiRowLayout(25) },
      },
      {
      ...
      },
      {
        title: "SLA urgentes",
        chartType: "bar",
        dataSource: "embed_sla_urgent",
        size: "medium",
        config: { layout: { colSpan: 50, minHeightPx: 320 } },
      },
      {
        title: "Por prioridad",
        chartType: "pie",
  ...
  },
  {
    id: "sla-en-riesgo",
    name: "SLA en riesgo",
    description: "Foco de turno: vencidos, urgentes, alta prioridad y MTTR.",
    accentColor: "#F43F5E",
    icon: AlertTriangle,
    widgets: [
      {
      ...
      },
      {
        ...
        dataSource: "kpi_sla_vencidos",
        size: "small",
        config: { accentColor: "#F43F5E", ...kpiRowLayout(33) },
      },
      {
        title: "Alta prioridad",
        chartType: "kpi",
        dataSource: "kpi_alta_prioridad",
        size: "small",
        config: { accentColor: "#DC2626", ...kpiRowLayout(34) },
      },
      {
        title: "SLA urgentes",
        chartType: "bar",
        dataSource: "embed_sla_urgent",
        size: "large",
        config: { layout: { colSpan: 55, minHeightPx: 360 } },
      },
      {
        title: "Cumplimiento diario",
        chartType: "area",
        dataSource: "sla_compliance",
        size: "large",
        config: { accentColor: "#059669", layout: { colSpan: 45, minHeightPx: 360 } },
      },
      {
        title: "MTTR por prioridad",
        chartType: "bar_horizontal",
        dataSource: "mttr_by_priority",
        size: "medium",
        config: { accentColor: "#D97706", layout: { colSpan: 100, minHeightPx: 280 } },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Monitor operativo completo: salud del sistema, desvíos, handover, SLA urgentes y carga por turno.",
    accentColor: "#DC2626",
    icon: Monitor,
    widgets: [
      {
        ...
        chartType: "kpi",
        dataSource: "kpi_active_incidents",
        size: "small",
        config: { accentColor: "#DC2626", ...kpiRowLayout(25) },
      },
      {
        ...
        dataSource: "kpi_sla_vencidos",
        size: "small",
        config: { accentColor: "#EA580C", ...kpiRowLayout(25) },
      },
      {
        title: "Alta prioridad",
        chartType: "kpi",
      ...
      },
      {
        ...
        chartType: "bar",
        dataSource: "embed_health",
        size: "medium",
        config: { layout: { colSpan: 35, minHeightPx: 280 } },
      },
      {
      ...
      {
        title: "Handover reciente",
        chartType: "bar",
        dataSource: "embed_handover",
        size: "medium",
        config: { layout: { colSpan: 30, minHeightPx: 280 } },
      },
      {
      ...
      },
      {
        ...
        size: "medium",
        config: { accentColor: "#0891B2", layout: { colSpan: 50, minHeightPx: 320 } },
      },
      {
        title: "SLA urgentes",
        chartType: "bar",
        dataSource: "embed_sla_urgent",
        size: "large",
        config: { layout: { colSpan: 60, minHeightPx: 360 } },
      },
      {
        title: "Buses anómalos",
        chartType: "treemap",
        dataSource: "anomalous_buses",
        size: "large",
        config: { accentColor: "#B45309", layout: { colSpan: 40, minHeightPx: 360 } },
      },
    ],
  },
];
